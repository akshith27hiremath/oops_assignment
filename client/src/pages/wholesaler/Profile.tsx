 ...
 * View and edit wholesaler profile and business information
 */
          ...
          <div className="md:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-4">
                  {getUserInitials()}
                </div>
                ...
                {user?.store && (
                  <div className="mt-6 w-full p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                      placeholder="Tell retailers about your wholesale business..."
                    />
                  </div>
